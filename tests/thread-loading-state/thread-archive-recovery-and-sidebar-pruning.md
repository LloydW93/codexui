...
5. Confirm the renamed thread disappears immediately and does not reappear after sidebar refresh or after clicking `Load older threads`.
...
- Older unarchived threads may appear as explicit older pages are loaded, but archived threads do not remain visible.
